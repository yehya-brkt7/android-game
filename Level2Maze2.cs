...
//This script is to generate a maze 

public class Level2Maze2 : MonoBehaviour
{
    #region Variables:
    // ------------------------------------------------------
    ...
    public void CreateLayout()
    {
		...
		Vector2 startPos = new Vector2(-750,45);
    ...
    public void MakeExit()
    {
        ...
        Cell newCell = edgeCells[Random.Range(0, 6)];
	...
	public void MakeExit2()
    {
        ...
        // Get edge cell randomly from list.
        Cell newCell = edgeCells[Random.Range(22,24)];  //edgeCells.Count
